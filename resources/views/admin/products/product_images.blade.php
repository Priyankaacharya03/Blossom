        ...
        <div class="col-lg-6 position-relative">
            <div class="d-flex flex-column-reverse md-flex-row gap-4">
                ...
                <div class="d-flex gap-3 mt-3">
                    @foreach($product->images->take(3) as $image) <!-- Fetching the first 3 images from the product_images table -->
                    <button class="thumbnail-btn w-24 h-24 overflow-hidden rounded-lg">
