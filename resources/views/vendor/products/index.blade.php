                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a
                                                ...
                                                href="{{ route('vendor.product.edit',$product->id) }}"
                                                role="button">Edit</a>

                                            <form action="{{ route('vendor.product.delete',$product->id) }}" onclick="return confirm('Are you sure you want to delete this product? This action cannot be undone.')" method="post" class="d-inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button
                                                    type="submit"
